...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import pandoc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("c5432543-76ad-5c9d-82bf-db097047a5e2"))
platforms = [Pkg.Artifacts.unpack_platform(e, "pandoc", artifacts_toml) for e in artifacts["pandoc"]]
...
if best_platform === nothing
    @debug("Unable to load pandoc; unsupported platform $(triplet(platform_key_abi()))")
else
